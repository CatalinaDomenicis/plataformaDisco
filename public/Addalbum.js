...
async function loadAlbums() {
    try {
        const response = await axios.get('https://plataformadisco-coxn.onrender.com//band/band');
...
document.getElementById('album-form').addEventListener('submit', async (event) => {
    ...
    try {
        const response = await axios.post('https://plataformadisco-coxn.onrender.com//band/band', albumData);
...
document.getElementById('guardarcambios').addEventListener('click', async () => {
    ...
    try {
        const response = await axios.put(`https://plataformadisco-coxn.onrender.com//band/band/${editingAlbumId}`, albumData);
...
async function deleteAlbum(id) {
    if (confirm('¿Estás seguro de que quieres eliminar este álbum?')) {
        try {
            await axios.delete(`https://plataformadisco-coxn.onrender.com//band/band/${id}`);
...
document.getElementById('addSongButton').addEventListener('click', async() => {
    ...
    axios.post(`https://plataformadisco-coxn.onrender.com//band/${currentAlbumId}/songs`, { titulo: songName, duracion: songDuration })
      .then(() => {
...
function deleteSong(albumId, songId) {
    axios.delete(`https://plataformadisco-coxn.onrender.com//band/${albumId}/songs/${songId}`)
      .then(() => {
